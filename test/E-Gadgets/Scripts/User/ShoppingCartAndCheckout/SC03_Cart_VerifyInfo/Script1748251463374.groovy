...
WebUI.verifyElementVisible(makeTO("//th[contains(text(),'Ảnh')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(text(),'Sản phẩm')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(text(),'Giá')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(text(),'Số lượng')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(text(),'Tổng tiền')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(text(),'Bỏ sản phẩm')]"))
