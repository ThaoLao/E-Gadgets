...
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Tên đăng nhập')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Họ và tên')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Số điện thoại')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Địa chỉ')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Vai trò')]"))
