...
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/Admin/Admin_Category/Input_Category_Name'), "A")
...
try {
    util.updateExcelTestResult('e:/Support_DoAn/LaoThanhThao/Source/TestCase_DoAn_LaoThanhThao.xlsx', 'Quản lý danh mục', 'Báo lỗi yêu cầu độ dài tối thiểu', 'Pass', 'Pass')
} catch (Exception e) {}
