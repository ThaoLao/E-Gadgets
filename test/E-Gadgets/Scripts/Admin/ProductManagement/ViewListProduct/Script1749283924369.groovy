...
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Tên sản phẩm')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Người nhập hàng')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Nhà phân phối')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Ngày nhập kho')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Giá gốc')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Giá sale')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Số lượng')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Khối lượng')]"))
WebUI.verifyElementVisible(makeTO("//th[contains(normalize-space(.),'Ảnh bìa')]"))
