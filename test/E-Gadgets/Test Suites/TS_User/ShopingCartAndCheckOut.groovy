...
@SetUp(skipped = false)
def setUp() {
	new utils.openLoginPage().navigateToLogin()
	String email = GlobalVariable.User_Email
	String password = String.valueOf(GlobalVariable.General_Password)
	...
	// Bảo đảm đang ở trang chủ để bắt đầu flow happy path
