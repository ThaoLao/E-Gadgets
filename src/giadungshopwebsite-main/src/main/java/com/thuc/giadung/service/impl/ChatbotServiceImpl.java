...
import com.thuc.giadung.config.OpenAIConfig;
import com.thuc.giadung.dto.chat.ChatMessage;
import com.thuc.giadung.dto.chat.ChatRequest;
import com.thuc.giadung.dto.chat.ChatResponse;
...
// Add helper methods to detect category requests
    ...
    private ChatbotResponse getQuotaExceededResponse(String message) {
        String response = "Xin lỗi, hệ thống trợ lý đồ điện tử của chúng tôi đang tạm thời quá tải. " +
                "Tôi sẽ cố gắng tìm một số đồ điện tử phù hợp với yêu cầu của bạn dựa trên từ khóa.";
    ...
    private ChatbotResponse getFallbackResponse(String message) {
        String response = "Xin lỗi, tôi không thể xử lý yêu cầu của bạn lúc này. " +
                "Dưới đây là một số đồ điện tử phổ biến mà bạn có thể quan tâm:";
