...
import com.thuc.giadung.repository.ProductRepository;
import com.thuc.giadung.repository.CategoryRepository;
...
public class MockChatbotServiceImpl implements ChatbotService {
    ...
    static {
        ...
        PREDEFINED_RESPONSES.put(
                ...
                "Xin chào! Tôi là trợ lý đồ điện tử của Rooks Products. Bạn đang tìm kiếm đồ điện tử gì? Tôi có thể giúp bạn tìm đồ điện tử theo thể loại, người sản xuất, hoặc chủ đề bạn quan tâm."
        );

        PREDEFINED_RESPONSES.put(
                "recommend|đề xuất|gợi ý|suggest",
                "Dưới đây là một số đồ điện tử phổ biến mà tôi đề xuất cho bạn. Bạn có thể cho tôi biết thêm về sở thích đọc đồ điện tử của bạn để tôi có thể đưa ra gợi ý phù hợp hơn không?"
        );
        ...
        PREDEFINED_RESPONSES.put(
                ...
                "Đồ Điện Tử khoa học là lựa chọn tuyệt vời để mở rộng kiến thức. Dưới đây là một số đồ điện tử khoa học phổ biến trong cửa hàng của chúng tôi. Bạn quan tâm đến lĩnh vực khoa học cụ thể nào không?"
        );

        PREDEFINED_RESPONSES.put(
                "history|lịch sử|historical",
                "Đồ Điện Tử lịch sử giúp chúng ta hiểu rõ hơn về quá khứ. Dưới đây là một số đồ điện tử lịch sử hay trong cửa hàng của chúng tôi. Bạn quan tâm đến lịch sử của quốc gia hay thời kỳ nào cụ thể không?"
        );

        PREDEFINED_RESPONSES.put(
                "self-help|self help|phát triển bản thân|kỹ năng sống",
                "Đồ Điện Tử phát triển bản thân là công cụ tuyệt vời để cải thiện cuộc sống. Dưới đây là một số đồ điện tử phát triển bản thân phổ biến trong cửa hàng của chúng tôi."
        );

        PREDEFINED_RESPONSES.put(
                "children|trẻ em|kids|thiếu nhi",
                "Đồ Điện Tử thiếu nhi là món quà tuyệt vời cho trẻ em. Dưới đây là một số đồ điện tử thiếu nhi phổ biến trong cửa hàng của chúng tôi. Bạn đang tìm đồ điện tử cho trẻ ở độ tuổi nào?"
        );

        PREDEFINED_RESPONSES.put(
                "business|kinh doanh|marketing|management|quản lý",
                "Đồ Điện Tử kinh doanh giúp phát triển kỹ năng và kiến thức trong lĩnh vực này. Dưới đây là một số đồ điện tử kinh doanh phổ biến trong cửa hàng của chúng tôi."
        );

        PREDEFINED_RESPONSES.put(
                ".*",
                "Cảm ơn bạn đã chia sẻ. Dưới đây là một số đồ điện tử có thể phù hợp với yêu cầu của bạn. Nếu bạn muốn tìm đồ điện tử cụ thể hơn, hãy cho tôi biết thêm chi tiết về sở thích của bạn."
        );
    ...
    public ChatbotResponse processMessage(String message) {
        ...
        if (recommendedProducts.isEmpty()) {
            ...
            if (containsCategoryRequest(message)) {
                return new ChatbotResponse(
                        "Xin lỗi, tôi không tìm thấy đồ điện tử nào phù hợp với thể loại bạn yêu cầu. " +
                                "Có thể chúng tôi chưa có đồ điện tử thuộc thể loại này hoặc bạn có thể thử tìm với từ khóa khác. " +
                                "Dưới đây là một số đồ điện tử phổ biến bạn có thể quan tâm:",
                        getPopularProducts(5)
                );
            } else {
                // Generic no results found
                return new ChatbotResponse(
                        "Xin lỗi, tôi không tìm thấy đồ điện tử nào phù hợp với yêu cầu của bạn. " +
                                "Bạn có thể thử tìm với từ khóa khác hoặc xem một số đồ điện tử phổ biến dưới đây:",
                        getPopularProducts(5)
                );
            }
        }
        ...
        if (isCategorySpecificQuery(message)) {
            ...
            if (!categoryName.isEmpty()) {
                response = "Dưới đây là một số đồ điện tử thuộc thể loại " + categoryName + " mà bạn có thể quan tâm:";
            }
        }
    ...
    private boolean containsCategoryRequest(String message) {
        ...
        return lowercaseMsg.contains("thể loại") ||
                lowercaseMsg.contains("loại đồ điện tử") ||
    ...
    private boolean isCategorySpecificQuery(String message) {
        ...
        String[] genreKeywords = {
                ...
                "tham khảo", "đồ điện tử giáo khoa", "truyện tranh", "manga", "comic"
        };
    ...
    private List<String> extractKeywordsFromUserMessage(String message) {
        ...
        Set<String> stopWords = new HashSet<>(Arrays.asList(
                ...
                "tạm biệt", "gợi ý", "đề xuất", "đồ điện tử", "cuốn", "quyển", "đọc", "mua", "bán"
        ));
